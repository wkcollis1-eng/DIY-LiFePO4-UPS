...
|---|---|
| Mean Well HDR-60-12 PSU | Velcro to enclosure base and stabilize to wall |
...
| Battery (V+) | Input 1 (+) Via F2 (10A) | Terminal Block has 2 inputs |
...
| Terminal Block − | BP-65 GND terminal | Included 1.5mm² wire |
...
| F4 output | XB7 Modem barrel plug (center +) | Proprietary, center-positive |
...
- All 16AWG runs are kept to approximately 6" segments to hold voltage drop within the analyzed 41mV budget at typical load.
