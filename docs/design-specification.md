...
| ER-2 | Typical load capacity | ≥15W continuous | Combined device load is 13.68W typical |
...
|---|---|---|
| Typical load | 13.68W DC | Kill-a-Watt measurement × 82.5% efficiency |
| Peak load | 18.67W DC | Kill-a-Watt peak measurement × 82.5% efficiency |
| Runtime at typical load | 8.2 hours | 112.5Wh usable ÷ 13.68W |
